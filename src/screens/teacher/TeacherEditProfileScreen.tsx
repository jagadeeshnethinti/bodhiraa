/**
 * Teacher · Edit profile — personal & teaching details using the hardened auth
 * field components. Premium gradient-header sheet; saving confirms and returns.
 */
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.sheet} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
        ...
        <EmailField label="EMAIL ADDRESS" value={email} onChangeText={setEmail} placeholder="you@school.edu" />
        <PhoneField label="MOBILE NUMBER" value={phone} onChangeText={setPhone} placeholder="98765 43210" />
        <AuthField label="PRIMARY SUBJECT" icon="flask" value={subject} onChangeText={setSubject} placeholder="e.g. Physics" autoCapitalize="words" />
